  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setGlobalProgress(prev => {
        ...
        // Reveal 4th coat at 30%
        if (newProgress >= 30 && visibleShoes === 3) {
          setVisibleShoes(4);
          setCarouselOffset(-90); // Slide left to show 4th coat
        }
        
        // Reveal 5th coat at 60%
        if (newProgress >= 60 && visibleShoes === 4) {
          setVisibleShoes(5);
          setCarouselOffset(-180); // Slide left to show 5th coat
        }
          ...
          >
            {Array.from({ length: 5 }, (_, index) => (
              <div
                ...
                style={{ left: `${(index - 1) * 180}px` }}
              >
                {/* Coat Silhouette SVG - Your Custom Design */}
                <div className="shoe-silhouette">
                  <svg width="300" height="150" viewBox="0 0 512 512">
                    {/* Main coat body */}
